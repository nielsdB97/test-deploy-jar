...
Ascii Doctor is een doc-as-code oplossing waarbij de documentatie bij de code wordt bewaard.
Tijdens het maken van het software product wordt deze documentatie omgezet naar PDF (of HTML5) en kan worden uitgeleverd met het product.
